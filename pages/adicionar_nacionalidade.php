...
<head>
    ...
    <title>Formulário de Nacionalidade - IMDB</title>
...
<body>
    ...
    <div class="container mt-5 mb-5">
        ...
        <p>Preencha as informações da nova nacionalidade.</p>

        <form action="../actions/nacionalidade/nacionalidade_create.php" method="POST">
            <div class="mb-3">
