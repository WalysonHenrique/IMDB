        ...
        <form action="../actions/ator/ator_update.php" method="POST">
            ...
            <div class="mb-3">
                ...
                <select id="sexo" name="sexo" class="form-select" required>
                    ...
                    <option value="M" <?php if (($ator['sexo'] ?? '') === 'M')
                        echo 'selected'; ?>>Masculino</option>
                    <option value="F" <?php if (($ator['sexo'] ?? '') === 'F')
                        echo 'selected'; ?>>Feminino</option>
                    <option value="O" <?php if (($ator['sexo'] ?? '') === 'O')
            ...
            <div class="mb-3">
                ...
                <select name="nacionalidadeID" id="nacionalidadeID" class="form-select" required>
                    ...
                    <?php foreach ($nacionalidades as $nacionalidade): ?>
                        <option value="<?php echo $nacionalidade['id']; ?>" <?php if (($ator['nacionalidadeID'] ?? '') == $nacionalidade['id'])
                               echo 'selected'; ?>>
